...
sudo mv ./web/sass ./web/static ./web/templates ./virtualenv/{{cookiecutter.repo_name}}env/{{cookiecutter.repo_name}}site/
read command
...
docker-compose run --rm web activate.sh ./manage.py  {{cookiecutter.app_name}}
